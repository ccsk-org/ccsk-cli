...
export function getKitMeta(id) {
    return KIT_REGISTRY.find((k) => k.id === id);
}
export function getEnabledKits() {
    return KIT_REGISTRY.filter((k) => !k.comingSoon);
}
export function isKitEnabled(id) {
